    ...
    <>
      <footer className="w-full bg-gray-900 flex justify-center text-white py-5">
        <div className="w-[96%] flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-5 xl:w-[1300px]">
          ...
          <div className="space-y-3 lg:space-y-0 lg:flex lg:gap-7 xl:gap-16">
            <Link className="text-[18px] fontStyle flex">Katalog</Link>
            <Link to={'/aksiyalar'} className="text-[18px] fontStyle flex">Aksiyalar</Link>
            <Link to={'/kredit'} className="text-[18px] fontStyle flex">Kredit</Link>
            <Link to={'./kontactlar'} className="text-[18px] fontStyle flex">Kantactlar</Link>
          </div>
          <div className="">
      ...
      <div className="w-full bg-gray-800 flex justify-center py-3">
        <div className="w-[96%] flex flex-col lg:flex-row justify-between lg:flex lg:w-[1300px]">
          <p className="text-[14px] fontStyle text-gray-500">©2024 - autoposter, barcha huquqlar himoyalangan</p>
          <p className="text-[14px] fontStyle text-gray-500">Maxfiylik politikasi</p>
        </div>
      </div>
    </>
  );
